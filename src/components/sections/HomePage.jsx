      ...
      <ReviewOnScroll>
        <div className="text-center z-10 px-4 max-w-5xl mx-auto">
          ...
          <p className="text-lg  max-w-lg mx-auto text-purple-200 mb-8 ">
            I am a passionate web developer who loves learning new technologies
            and applying my knowledge to build meaningful and innovative
            projects. I enjoy tackling challenges and continuously improving my
